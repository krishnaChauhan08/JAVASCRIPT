...
// concept in the language and is based on the prototype model.
...
// (often referred to as __proto__), which points to its prototype object.
// When you access a property or method on an object, and that property or method
// is not found in the object itself, JavaScript looks for it in the object's prototype
// (and further up the prototype chain, if needed) until it finds the property or reaches
// the top of the prototype chain, which is usually the Object.prototype.
